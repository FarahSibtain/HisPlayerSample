...
public class HISPlayerStereoSample : HISPlayerManager
{
    [Header("Misc")]
    ...
    private string videoName = "StereoSBS_Video.mp4";
    ...
    private void SetUpMetaQuest()
    {
        ...
        if (sceneName == "HISPlayerMetaQuestStereoExtSurface")
        {
            ...
            if (overlay.isExternalSurface)
            {
                OVROverlay.ExternalSurfaceObjectCreated surfaceCreatedCallback = () =>
                {
                    ...
                    // Set stereoscopic Side by Side or Left/Right rendering
                    ...
                    SetStereoscopicRendering(streamIndex, HISPlayerStereoMode.TopBottom, ref overlay.overrideTextureRectMatrix, ref overlay.srcRectLeft, ref overlay.srcRectRight, ref overlay.destRectLeft, ref overlay.destRectRight);
                };
        ...
        else if (sceneName == "HISPlayerMetaQuestStereoRT")
        {
            SetUpPlayer();
        }
    }
    ...
    public void OnPreviousPlayback()
    {
        ...
        ChangeVideoContent(streamIndex, videoName);
    }
